...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-1000 w-full py-4 transition-all duration-300 ${isScrolled ?'bg-black/30 bqckdrop-blur-lg'
      : 'bg-transparent'}`}
      ...
      <div className='max-w-[1320px] mx-auto px-5'>
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center gap-4'>
            ...
            className='text-2xl font-bold bg-linear-to-r from-slate-700 via-sky-700 to-cyan-700 bg-clip-text text-transparent hover:opacity-80 transition-opacity'
