  ...
  return (
    <section id='projects' className='relative py-20 bg-black overflow-hidden'>
        <div className='absolute inset-0 overflow-hidden'>
            <div className='absolute top-1/3 right-0 w-96 h-96 bg-cyan-950 opacity-20 rounded-full blur-3xl' />

            <div className='absolute bottom-1/3 left-0 w-96 h-96 bg-cyan-950 opacity-20 rounded-full blur-3xl' />
            <div className='absolute top-1/2 right-1/3 w-96 h-96 bg-cyan-950 opacity-20 rounded-full blur-3xl ' />
        </div>
            ...
            <FadeIn delay={0}>
                <div className='text-center mb-12'>
                    <div className='inline-flex items-center gap-2 px-4 py-2 bg-cyan-950 border border-sky-700 rounded-full mb-6'>
                        ...
                        <span className='text-sm text-sky-500 font-medium'>My Work</span>
                    </div>
                        ...
                        <button 
                              ...
                              : 'text-white/60 hover:text-white'
                                ...
                                {activeCategory === category && (
                                    <div className='absolute inset-0 rounded-full bg-sky-600 blur-xl opacity-50 -z-10' />
                                )}
                            </button>
                    ))}
                </div>
